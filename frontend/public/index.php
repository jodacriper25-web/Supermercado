...
<section id="promoCarouselContainer" class="container mt-3">
  <div id="promoCarousel" class="carousel slide rounded shadow-sm" data-bs-ride="carousel">
...
<main class="container container-main">
  ...
  <!-- ================= MENSAJE VACÍO ================= -->
  <div id="emptyMsg" class="text-center text-muted my-4 d-none">
    No se encontraron productos 😕
  </div>

  <!-- ================= CARGAR MÁS ================= -->
  <div id="loadMoreContainer" class="text-center my-4 d-none">
